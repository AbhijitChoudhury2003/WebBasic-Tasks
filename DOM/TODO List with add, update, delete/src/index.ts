...
interface TODO{
  id: string; ///for every task a Unique ID so ID as string
  task: string;
}
...
////////Adding task
let form = document.getElementById("form") as HTMLFormElement; //this is known as TYpe ASSertion (means that ik more than TS)
